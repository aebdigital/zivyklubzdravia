...
const MOBILE_DRAWER_DURATION_MS = 320;
      ...
      {isDrawerVisible ? (
        <div className="fixed inset-0 z-[200] md:hidden">
          <button
            ...
            } bg-[rgba(17,27,20,0.3)]`}
            aria-label="Zavrieť navigáciu"
            onClick={closeDrawer}
          />

          <aside
            className={`fixed inset-y-0 left-0 flex h-screen min-h-screen w-screen flex-col overflow-y-auto bg-[linear-gradient(135deg,#315433,#4d6f38)] px-4 pb-8 pt-2 text-white shadow-[0_30px_90px_rgba(17,27,20,0.45)] ${
              isClosing ? "mobile-nav-drawer-out" : "mobile-nav-drawer-in"
            }`}
          >
